					...
					<div class="main-header-right">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{URL::current()}}?lang=ar">Arabic</a>
                            </div>
                        </div>
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									...
									<div class="main-notification-list Notification-scroll">
										...
										<a class="d-flex p-3 border-bottom" href="{{   $notification->data['url']}}?notify_id={{ $notification->id }}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{ $notification->data['title'] }}</h5>
												<div class="notification-subtext">{{  $notification->data['invoice_number'] }}</div>
