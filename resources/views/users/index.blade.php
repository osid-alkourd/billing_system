...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('users')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('list')}}
                {{__('users')}}</span>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        @can('add user')
                            <a class="btn btn-primary btn-sm" href="{{ route('users.create') }}">{{__('add user')}}</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">{{__('user status')}}</th>
                                <th class="wd-15p border-bottom-0">{{__('user type')}}</th>
                                <th class="wd-10p border-bottom-0">{{__('Operations')}}</th>
                            </tr>
                            </thead>
                            <tbody>
